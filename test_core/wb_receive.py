...
class RTLreceive (Module, AutoCSR, AutoDoc):
    def __init__(self, platform):
        ...
        packet_in = Signal()
        self.comb += [
            self.data.storage.eq(packet_in)
        ]
        ...
        self.specials += Instance("test_send",
            ...
            i_packet_out = packet_out,
            i_packet_out_valid = packet_out_valid,
            )

        platform.add_source("/home/eightpins/litex/IP/test_core/receive.v")